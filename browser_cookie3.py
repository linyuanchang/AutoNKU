    ...
    def __init__(self, cookie_file=None, domain_name="", key_file=None):
        args = {
            ...
            'windows_cookies':[
                    ...
                    {'env':'APPDATA', 'path':'..\\Local\\Microsoft\\Edge\\User Data\\Profile 1\\Network\\Cookies'},
                    {'env':'LOCALAPPDATA', 'path':'Microsoft\\Edge\\User Data\\Default\\Cookies'},
                    {'env':'LOCALAPPDATA', 'path':'Microsoft\\Edge\\User Data\\Profile 1\\Network\\Cookies'},
                    {'env':'APPDATA', 'path':'Microsoft\\Edge\\User Data\\Default\\Cookies'},
                    {'env':'APPDATA', 'path':'Microsoft\\Edge\\User Data\\Profile 1\\Network\\Cookies'}
            ],
